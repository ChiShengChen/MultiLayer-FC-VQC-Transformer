...
While this trails CatBoost ($0.861$) and XGBoost ($0.856$), it substantially outperforms MLP$_{720}$ ($R^2{=}0.758$)---an MLP with the same parameter count---confirming that VQC's inductive bias provides genuine representational benefit beyond mere parameter count.
On CA Housing and Concrete, MLP$_{720}$ achieves $R^2{=}0.812$ and $0.866$, outperforming FC-VQC ($0.750$, $0.774$) but trailing QT ($0.807$, $0.853$).

...
\begin{itemize}[leftmargin=*]
    ...
    \item Evidence that \textbf{FC-VQCs are the most parameter-efficient} quantum architecture, achieving 90--96\% of the $R^2$ of attention-based VQCs at 40--50\% fewer parameters, and consistently outperforming equal-capacity MLPs (721 params). On all datasets, FC-VQCs trail gradient-boosted trees but remain competitive with ${\sim}$500--720 parameters versus ${\sim}$720 for an equal-capacity MLP that underperforms them. All claims are validated with 3-seed mean $\pm$ std.

...
\begin{table}[t]
\centering
\caption{Test accuracy on classification datasets. All quantum-model results: 3-seed mean $\pm$ std. Best overall mean per column in \textbf{bold}. \#p reported for the Wine R+W setting; MNIST counts (612/550/1078/658 for FC/ResNet/QT/FQT) are similar.}
...
QT & $.565{\scriptstyle\pm.023}$ & $.567{\scriptstyle\pm.015}$ & $\mathbf{.942}{\scriptstyle\pm.003}$ & 1098 \\
...
Among quantum models, FQT achieves the highest mean accuracy on Wine Red ($0.606 \pm 0.017$), and on the simpler binary MNIST 4v9 task all four architectures cluster within 0.6\% of each other (mean ${\approx}$93.6--94.2\%), with QT and FQT marginally ahead but well within seed variance.

...
The core insight is \textbf{parameter efficiency}: FC-VQC with Type~4 connectivity achieves 85--95\% of the performance of explicit attention architectures using 40--80\% fewer parameters.
...
FC-VQCs match gradient-boosted trees on regression with only ${\sim}$700 parameters, while attention-based VQCs require $2{\times}$--$6{\times}$ more parameters for comparable or lower accuracy.

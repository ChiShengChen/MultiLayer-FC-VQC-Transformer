...
\IEEEauthorblockA{\textit{Beth Israel Deacones Medical Center} \\
...
Across all datasets, FC-VQCs consistently outperform parameter-matched MLPs ($R^2{=}0.769$ on Boston with 218 parameters), confirming that quantum circuits provide genuine representational benefit beyond mere parameter count.

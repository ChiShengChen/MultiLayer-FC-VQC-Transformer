...
FOLDER_NAMES = ["MLPClassifier", "12t8t6", "22t8t6", "33t12t8t6", "44t15t10t8t6", "54t18t6", "66t24t8t6"]   # add more, e.g. ["54t18t6", "another_folder"]
...
FILE_PATTERNS_TEMPLATES = [
    ...
    r"SingleVQC_{folder}_L(?P<L>\d+)_K(?P<D>\d+)_stats(?:\.\w+)?$",
